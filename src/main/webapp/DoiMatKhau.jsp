...
<body>
    ...
    <div class="content">
     <jsp:include page="header.jsp" />
        ...
        Admin admin = adminDAO.selectByMaAdmin(maAdmin);
        %>
        ...
        <form action="admin" method="post" class="mt-4">
            ...
            <div class="form-group">
                <label for="maadmin">Mã Admin:</label>
                <input type="text" id="maadmin" name="maadmin" class="form-control" value="<%= admin.getMaAdmin() %>" readonly>
            </div>
        ...
        <p class="mt-3 text-center"><a href="index.jsp">Trở về trang chủ</a></p>
    </div>
