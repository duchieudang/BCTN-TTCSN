...
<body>
	...
	<div class="content">
		...
		<div class="container">
			...
			<a href="ChiTietNganh5.jsp?makhoa=<%=nganh.getKhoa().getMaKhoa()%>"
		...
		<div class="table-responsive">
			<table class="table table-bordered text-center" id="khoaTable">
				...
				<tbody>
					...
					<tr>
						<td><%=stt++%></td>
						<td><%=hp.getMaHocPhan()%></td>
						<td><%=hp.getTenHocPhan()%></td>
						<td><%=hp.getTinChi()%></td>
						<td><%=hp.getHocKy()%></td>
						<td><%=hp.getBatbuoc()%></td>
						<td><a href="ChiTietMonHoc.jsp?mahocphan=<%=hp.getMaHocPhan()%>"
