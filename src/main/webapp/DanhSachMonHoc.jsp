            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="DanhSachLop.jsp?mamonhoc=<%= monHoc.getMaMonHoc() %>"
                            class="btn btn-info btn-action">Diểm Danh</a></td>
                             <td><a href="QuanLyDiem.jsp?mamonhoc=<%= monHoc.getMaMonHoc() %>"
                            class="btn btn-info btn-action">Quản Lý Điểm</a></td>
                    </tr>
                    <%
                        }
                    }
