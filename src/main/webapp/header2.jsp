...
%>
        ...
        <span><%= giangvien.getTenGiangVien() %></span> 

        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="CapNhapThongTin2.jsp?magiangvien=<%=giangvien.getMaGiangVien()%>">Thay đổi thông tin</a></li>
             <li><a class="dropdown-item" href="DoiMatKhau2.jsp?magiangvien=<%=giangvien.getMaGiangVien()%>">Đổi mật khẩu</a></li>
